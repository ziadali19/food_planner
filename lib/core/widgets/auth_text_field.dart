...
import '../helpers/check_text_language.dart';
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
              ...
              OutlineInputBorder(
                borderSide: BorderSide(
                  color: Colors.black.withOpacity(
                      0.15), //BorderSide(width: 1, color: Color(0xFF79747E))
                  width: 0.5.w,
                ),
                borderRadius: BorderRadius.circular(4.r),
              ),
          ...
          errorBorder: OutlineInputBorder(
            borderSide: BorderSide(
              color: ColorsManager.trashIconColor,
              width: 1.w,
            ),
            borderRadius: BorderRadius.circular(4.r),
          ),
          ...
          hintStyle: hintStyle ??
              TextStyles.font12Black600.copyWith(
                  fontFamily: setFontFamilyDueToText(hintText ?? ''),
          ...
          prefixIconConstraints:
              BoxConstraints(minWidth: 16.w, minHeight: 17.h),
